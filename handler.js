...
global.dfail = (type, m, conn) => {
    const msg = {
rowner: `El comando *${global.comando}* está restringido exclusivamente al creador del bot.`,
        owner: `El comando *${global.comando}* requiere privilegios de desarrollador.`,
        mods: `El comando *${global.comando}* está disponible únicamente para moderadores autorizados.`,
        premium: `El comando *${global.comando}* es exclusivo para usuarios premium.`,
        group: `El comando *${global.comando}* solo está disponible en grupos.`,
        private: `El comando *${global.comando}* únicamente puede ejecutarse en chat privado.`,
        admin: `El comando *${global.comando}* requiere permisos de administrador del grupo.`,
        botAdmin: `Para ejecutar el comando *${global.comando}* necesito ser administrador del grupo.`,
        restrict: `Esta funcionalidad se encuentra deshabilitada temporalmente.`,
        unreg: `Para usar el comando *${global.comando}* es necesario estar registrado.\n\nRegístrate usando:\n/reg nombre.edad\n\nEjemplo:\n/reg ${m.name || 'Usuario'}.18`
    }[type]
